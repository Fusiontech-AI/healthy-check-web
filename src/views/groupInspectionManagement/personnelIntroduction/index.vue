      ...
      <el-col :span="19">
        <el-card class="content">
          ...
          <div>
            ...
            <SearchForm :columns="formColumns" :search-param="formValue" :search-col="3" />
          </div>
          <div>
            <div class="my-2">
            ...
            <div class="table-box">
              <ProTable :columns="personInforColumns" :toolButton="false" :data="[{ name: 'aaaaaakaskhaskhahadhsa,d' }]">
