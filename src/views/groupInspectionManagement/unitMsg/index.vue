        ...
        <el-col :span="5">
          <div class="flex justify-between mt-[10px]">
            ...
            <el-tooltip class="box-item" content="新增单位" placement="top">
              <div
                class="add-circle w-[24px] h-[24px] cursor-pointer bg-[#2879FF] flex items-center justify-center"
                @click="handleAddUnit"
              >
                <el-icon color="#fff">
                  <Plus />
          ...
          <div class="my-[10px]">
            <el-alert type="info" center :closable="false" :show-icon="false" style="border: none">
              <div class="flex items-center">
                ...
                <span
                  v-if="selectTreeNodeName"
                  @click="handleClearSelectTreeNodeName"
                  class="flex items-center cursor-pointer px-[8px]"
                >
          ...
          <div class="right-top ml-[10px] h-[50px] flex justify-between items-center">
            ...
            <div class="pr-[10px]">
              <el-button
                type="danger"
                round
                v-if="activeTab === 0 && selectTreeNodeId"
                @click="handleDelete"
              >
                删除单位
              </el-button>
              <el-button round @click="handleCancle" v-if="!editFlag">取消</el-button>
              <el-button type="primary" round @click="handleSave" v-if="!editFlag">
                保存单位
              </el-button>
              <el-button type="primary" round @click="handleEdit" v-if="editFlag">
                编辑单位
              </el-button>
            </div>
          </div>
