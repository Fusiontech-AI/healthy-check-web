      ...
      <el-card shadow="hover">
        <div class="flex justify-between items-center">
          ...
          <div>
            ...
            <el-button round type="primary">登记</el-button>
...
import { formInfoColumns } from '@/views/deskRegistration/medicalRegistration/checkRegistration/rowColumns.tsx'
